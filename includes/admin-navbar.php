...
<head>
    ...
    <link rel="stylesheet" href="../includes/admin-navbar.css">
...
<body>
    ...
    <nav>
        <div class="nav-section">
            ...
            <ul class="nav-configs">
                <li><a href="#"><i class="fa-solid fa-circle-info"></i> Dashboard</a></li>
                <li><a href="#"><i class="fa-solid fa-list"></i>Patient's record</a></li>
                <li><a href="#"><i class="fa-solid fa-star"></i> Product</a></li>
            </ul>
            
            <i class="fa-solid fa-user"></i>
            <a href="#" class="signin">Account</a>
            <a href="#" class="book-btn">Profile</a>
            </div>
        </div>
