...
(function () {
  ...
  function updateSummaryView() {
    ...
    // 3. Get Selected Products (THE NEW PART)
    // We look for the new checkbox name we created: "selected_products[]"
    const productChecks = Array.from(document.querySelectorAll('input[name="selected_products[]"]:checked'));
    
    // Join them with a line break <br> so they stack nicely in the summary
    ...
    <div class="ams-review-summary" role="region" aria-label="Appointment summary">
      ...
      <div class="ams-summary-body">
        ...
        <div class="ams-summary-section">
          <div class="ams-summary-title">Selected Frames</div>
          <div class="ams-summary-row">
