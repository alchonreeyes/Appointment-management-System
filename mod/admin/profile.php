...
/* ======================================================= */
/* <-- START: BAGONG CSS para sa Loading Screen (TRANSPARENT)
/* ======================================================= */
#loader-overlay {
    position: fixed;
    inset: 0;
    /* Ginamit ang body background color na may transparency */
    ...
    /* Idinagdag ang blur effect para tumugma sa ibang modals */
    backdrop-filter: blur(4px); 
}
.loader-spinner {
    width: 50px;
