...
<div id="main-content">
    ...
    <div class="dashboard">
        ...
        <div class="print-header">
            ...
            <p><strong>Generated By:</strong> <?php echo htmlspecialchars($_SESSION['full_name'] ?? 'staff'); ?></p>
...
function updateScannedStatus(newStatus, reason = null) {
    ...
    if (newStatus === 'Cancel') bodyParams.reason = reason || 'Cancelled by staff via QR Scan.';
